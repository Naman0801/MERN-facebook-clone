...
const MessageSender = () => {
    ...
    const handleFileClick = () => document.getElementById('file').click();
            ...
            <div className="messageSender__top">
                ...
                <form >
                    ...
                    <p onClick={handleFileClick}>
                        <AddIcon className='messageSender__fileAddIcon' />
                        { image ? image.name : 'Select a file' }
                    </p>
                    <Input id='file' type="file" className='messageSender__fileSelector' onChange={handleChange} />
